      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        >
          ...
          >
            ...
            v{version} — Linear task queue, prompt queue, and resizable split panes
          </motion.div>
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-subtext md:text-xl">
            ...
            AI&nbsp;agent orchestration — with Linear integration, cross-repo automations, and prompt queues — in one native desktop app.
          </p>
